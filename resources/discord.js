function getData() {
	...
	track_name = tmp
	return {"artist": artist, "track_name": track_name, "track_img": track_img, "track_link": track_link, "current_time": new Date().getTime() + player_time.value * 1000, "track_lenght": new Date().getTime() + player_time.max * 1000, "enabled": JSON.parse(localStorage.getItem("discordRPC").toLowerCase())}
}
